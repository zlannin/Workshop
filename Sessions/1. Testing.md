...
### Unit Testing
- Fakes: A fake is a lightweight implementation of an interface that returns hard-coded values. Fakes are used in unit tests to isolate the code under test from the dependencies. Think database in memory colllection
